...
class EditCustomerProfileShimmer extends StatefulWidget {
  const EditCustomerProfileShimmer({super.key});

  @override
  State<EditCustomerProfileShimmer> createState() => _EditCustomerProfileShimmerState();
}

class _EditCustomerProfileShimmerState extends State<EditCustomerProfileShimmer> {
  @override
