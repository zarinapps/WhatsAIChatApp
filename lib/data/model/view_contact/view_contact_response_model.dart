...
//
//     final viewContactListUpdateesponseModel = viewContactListUpdateesponseModelFromJson(jsonString);

import 'dart:convert';

ViewContactListUpdateesponseModel viewContactListUpdateesponseModelFromJson(String str) =>
    ViewContactListUpdateesponseModel.fromJson(json.decode(str));

String viewContactListUpdateesponseModelToJson(ViewContactListUpdateesponseModel data) => json.encode(data.toJson());

class ViewContactListUpdateesponseModel {
  final String? remark;
  final String? status;
  final List<String>? message;
  final Data? data;

  ViewContactListUpdateesponseModel({this.remark, this.status, this.message, this.data});

  factory ViewContactListUpdateesponseModel.fromJson(Map<String, dynamic> json) => ViewContactListUpdateesponseModel(
    remark: json["remark"],
    status: json["status"],
...
class Data {
  ...
  Data({this.contactList, this.contacts, this.profilePath});
...
class ContactList {
  ...
  ContactList({this.id, this.userId, this.name, this.createdAt, this.updatedAt, this.contact});
...
class Contacts {
  ...
  factory Contacts.fromJson(Map<String, dynamic> json) => Contacts(
    ...
    data: json["data"] == null ? [] : List<ContactsData>.from(json["data"]!.map((x) => ContactsData.fromJson(x))),
...
class ContactsData {
  ...
  ContactsData({this.id, this.contactId, this.contactListId, this.createdAt, this.updatedAt, this.contact});
